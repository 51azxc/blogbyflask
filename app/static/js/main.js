...
var myApp = angular.module('myApp',['ui.bootstrap','ui.router', 'restangular', 'LocalStorageModule','textAngular', 'ngTagsInput']);
myApp.run(['$rootScope', '$location', '$state', '$stateParams', 'AuthService', 'Restangular',
