...
myApp.factory('User', ['Restangular', function(Restangular){
	var User = {
...
myApp.factory('Comment', ['Restangular', 'AuthService', function(Restangular, AuthService){
	var Comment = {
...
myApp.factory('Tag', ['Restangular', '$http', function(Restangular, $http){
	var Tag = {
		get: function(query){
